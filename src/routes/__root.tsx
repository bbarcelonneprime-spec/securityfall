...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "alex ia" },
      { name: "description", content: "alex ia est une IA complétement gratuit  qui a beaucoup de fonctionnalité" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "alex ia" },
      { property: "og:description", content: "alex ia est une IA complétement gratuit  qui a beaucoup de fonctionnalité" },
